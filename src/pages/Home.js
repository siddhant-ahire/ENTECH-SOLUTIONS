...
const Home = () => {
  ...
  const backgroundImageStyle4 = {
    ...
    const testimonials = [
      ...
      { imageUrl: "images/person_2.jpg", quote: "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.", name: "Jeff Freshman", position: "Guest" },
    ...
    <div>
      ...
      <div className="container d-flex align-items-center">
        ...
        <div className="collapse navbar-collapse" id="ftco-nav">
          ...
          <a href="#" className="btn-custom" data-toggle="modal" data-target="#exampleModalCenter">Inquire Now</a>
        </div>
      </div>
    </nav>
    </div>
            ...
            <div className="row justify-content-center mb-4 pt-md-4">
              <div className="col-md-12 heading-section">
                ...
                <div className="d-flex video-image align-items-center mt-md-4">
                  <a href="#" className="video img d-flex align-items-center justify-content-center" style={videoBackgroundImageStyle2}>
            ...
            <div className="ftco-footer-widget">
              ...
              <div className="d-flex">
                <ul className="list-unstyled mr-md-4">
                  ...
                  <li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Industries</a></li>
                </ul>
                <ul className="list-unstyled ml-md-5">
                  <li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Contact</a></li>
                  <li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Help</a></li>
                  <li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Privacy Policy</a></li>
                  <li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Terms of Use</a></li>
                </ul>
              </div>
            </div>
          </div>
